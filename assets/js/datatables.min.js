...
(function (f) {
	...
	q.defaults = {
		...
		oLanguage: {
			...
			sSearch: "Cari Karyawan <i class='fa fa-search' aria-hidden='true'></i> ",
			sSearchPlaceholder: "",
			sUrl: "",
	...
	q.ext = C = {
		...
		classes: {},
		build:
			"bs4/jq-3.3.1/dt-1.10.21/af-2.3.5/b-1.6.2/fc-3.3.1/fh-3.1.7/r-2.2.5/sc-2.0.2",
		errMode: "alert",
		feature: [],
		search: [],
...
(function (c) {
	...
	c.extend(h.prototype, {
		...
		scrollToRow: function (a, b) {
			...
			(e > this.s.redrawBottom || e < this.s.redrawTop) &&
				...
				((f = !0),
				(e = this._domain("virtualToPhysical", a * this.s.heights.row)),
				this.s.redrawTop < e &&
		...
		construct: function () {
			...
			if (this.s.dt.oFeatures.bPaginate) {
				...
				f &&
					f.scroller &&
					((this.s.topRowFloat = f.scroller.topRow),
					(this.s.baseScrollTop = f.scroller.baseScrollTop),
					(this.s.baseRowTop = f.scroller.baseRowTop));
				this.measure(!1);
		...
		_info: function () {
			if (this.s.dt.oFeatures.bInfo) {
				...
				h =
					...
					a.fnRecordsDisplay() == a.fnRecordsTotal()
						...
						? b.sInfo
								...
								.replace("_END_", k)
								.replace("_MAX_", l)
								.replace("_TOTAL_", m) + b.sInfoPostFix
						: b.sInfo
								.replace("_START_", h)
								.replace("_END_", k)
								.replace("_MAX_", l)
				...
				if ("undefined" != typeof f)
					for (e = 0, g = f.length; e < g; e++) c(f[e]).html(h);
	...
	m.register(["scroller().scrollToRow()", "scroller.toPosition()"], function (
		a,
		b
	) {
		this.iterator("table", function (d) {
