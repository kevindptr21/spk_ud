<div class="modal fade" id="alertError" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <? echo "<h4>".$this->session->flashdata('errMsg')." <i class='fa fa-check' aria-hidden='true'></i></h4>"; ?>
            </div>
